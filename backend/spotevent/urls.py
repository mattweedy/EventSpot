...
from backend.core.views import EventView, VenueView, UserView, apply_user_preferences, get_user_preferences, get_recommendations, save_remove_recommendation, delete_old_events
...
urlpatterns = [
    ...
    path('api/delete_old_events', delete_old_events, name='delete_old_events'),
