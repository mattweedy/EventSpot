...
from backend.core.views import EventView, VenueView, UserView, apply_user_preferences, get_recommendations
...
urlpatterns = [
    ...
    path('api/preferences', apply_user_preferences, name='apply_user_preferences'),
