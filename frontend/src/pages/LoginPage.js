...
const LoginPage = () => {
    return (
        <div className="login-page">
                <h1 className="login-page-title">Welcome to Event<span>Spot</span></h1>
                <div className="login-page-dialog">
                    ...
                    <p className="login-page-text">Event<span>Spot</span> aims to provide you with custom and personal event recommendations, based on your favourite genres gathered from your top listened tracks and artists from Spotify.</p>
